...
package com.dl2974.andmultithreads;
...
public final class Constants {
    ...
    public static final String ACTION_VIEW_IMAGE =
            "com.dl2974.andmultithreads.ACTION_VIEW_IMAGE";

    public static final String ACTION_ZOOM_IMAGE =
            "com.dl2974.andmultithreads.ACTION_ZOOM_IMAGE";
    
    // Defines a custom Intent action
    public static final String BROADCAST_ACTION = "com.dl2974.andmultithreads.BROADCAST";

    // Fragment tags
    public static final String PHOTO_FRAGMENT_TAG =
            "com.dl2974.andmultithreads.PHOTO_FRAGMENT_TAG";
    
    public static final String THUMBNAIL_FRAGMENT_TAG =
            "com.dl2974.andmultithreads.THUMBNAIL_FRAGMENT_TAG";

    // Defines the key for the status "extra" in an Intent
    public static final String EXTENDED_DATA_STATUS = "com.dl2974.andmultithreads.STATUS";

    // Defines the key for the log "extra" in an Intent
    public static final String EXTENDED_STATUS_LOG = "com.dl2974.andmultithreads.LOG";
    
    // Defines the key for storing fullscreen state
    public static final String EXTENDED_FULLSCREEN =
            "com.dl2974.andmultithreads.EXTENDED_FULLSCREEN";
